...
![](assets/01_Fundamentals/HJenAmxCT.jpg)
...
![](assets/01_Fundamentals/HJLsbmWRT.jpg)

- 追加或刪除資料時較費時間
- 若要插入的位置已有資料，需先依序將它們移位再插入

追加:
![](assets/01_Fundamentals/SyVvM7WCT.jpg)
刪除:
![](assets/01_Fundamentals/B19vM7b0p.jpg)
...
![20121027KfaEdl6AVY](assets/01_Fundamentals/SkxqiEQR6.jpg)
...
def reverse(self):
    ...
    self.head = prev
```
![linkedlist-reverse-iterative](assets/01_Fundamentals/SkD-tUBCT.png)

## 雙向鏈結串列Doubly Linked List
每個節點會變成==一個資料欄==與==兩個指標欄==，讓資料可以從頭或尾巴開始找，優點是可以讓被破壞或遺失的節點被找回來，但在追加或刪除資料時，必須更動==比單向鏈結串列更多的指標次數==。

![20121027GQdhacYTQ0](assets/01_Fundamentals/HkjUMB7R6.jpg)

## 環狀鏈結串列 Circular Linked List
在單向鏈結串列中，萬一某節點被破壞或遺失，整個串列將會沒作用，因此如果把串列最後一個節點指向串列頭，這樣==每個節點都可以是串列頭==。

![20121027lkG5jI8XoZ](assets/01_Fundamentals/BykFGr7Cp.jpg)

## 陣列與鏈結串列的優缺點比較
![20121027POuiLls7tO](assets/01_Fundamentals/ryS5fr7Aa.jpg)
...
![20121027edOmUwqfoe](assets/01_Fundamentals/HysfXES06.jpg)

使用陣列(Array)製作堆疊
![20121027cRE4REw4KL](assets/01_Fundamentals/HkXUQNSA6.jpg)

使用鏈結串列(Linked List)製作堆疊
![20121027lorqGb2vXF](assets/01_Fundamentals/SyoIQ4SAT.jpg)
...
### Enqueue的情況
![20121027OU2QKm6j55](assets/01_Fundamentals/ryZal2w0a.jpg)
### Dequeue的情況
![201210276YJ4rjLvqG](assets/01_Fundamentals/SkrAghDAa.jpg)
...
![20121027auspOHzYk5](assets/01_Fundamentals/HynWa-t0p.jpg)
...
![20121027ScabqSVxft](assets/01_Fundamentals/rkfKJzFAT.jpg)
...
![20121027YslMDxMQbP](assets/01_Fundamentals/HyDpyGKA6.jpg)
### 鏈結法(Chaining)
使用鏈結串列(Linked List)資料結構在每一組Bucket中。
![20121027hdzcEEqGsx](assets/01_Fundamentals/Bk1jjGKR6.jpg)
